...
try:
    print("Running database.py to update MongoDB...")
    subprocess.run(["python", "database.py"], check=True)
    print("database.py executed successfully.")
except subprocess.CalledProcessError as e:
    print(f"Error executing database.py: {e}")
except FileNotFoundError:
    print("database.py not found. Ensure it is in the same directory as this script.")

print("Training and database update process completed.")
